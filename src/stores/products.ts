...
export const useProductStore = defineStore('product', () => {
    const products = ref<Product[]>([
        // Electronics
        { id: 1, category: "Electronics", name: "Wireless Noise-Cancelling Headphones", description: "Premium over-ear headphones with active noise cancellation and 30-hour battery life.", price: 299.99, rating: 4.8, reviews: 1245, stock: 45, sold: 8500, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&q=80" },
        { id: 2, category: "Electronics", name: "Smart Watch Series 8", description: "Advanced health tracking, ECG app, blood oxygen sensor, and always-on retina display.", price: 399.00, rating: 4.9, reviews: 3210, stock: 105, sold: 15000, image: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=800&q=80" },
        ...
        { id: 5, category: "Electronics", name: "Portable Bluetooth Speaker", description: "Waterproof portable speaker with 360-degree sound and 24-hour playtime.", price: 129.00, rating: 4.8, reviews: 4500, stock: 200, sold: 12500, image: "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=800&q=80" },
        ...
        { id: 7, category: "Electronics", name: "Wireless Charging Pad", description: "Fast wireless charging pad compatible with all Qi-enabled devices.", price: 29.99, rating: 4.3, reviews: 3100, stock: 300, sold: 25000, image: "https://images.unsplash.com/photo-1603674554159-b62f6febbce5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },

        // Furniture
        { id: 8, category: "Furniture", name: "Ergonomic Office Chair", description: "Comfortable mesh office chair with lumbar support, adjustable armrests, and headrest.", price: 159.50, rating: 4.5, reviews: 832, stock: 12, sold: 3400, image: "https://images.unsplash.com/photo-1505843490538-5133c6c7d0e1?w=800&q=80" },
